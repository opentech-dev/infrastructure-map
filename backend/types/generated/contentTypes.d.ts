...
export interface ApiFilterFilter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    infrastructure: Attribute.Relation<
      'api::filter.filter',
      'manyToOne',
      'api::infrastructure.infrastructure'
    >;
    filter_items: Attribute.Relation<
      'api::filter.filter',
      'oneToMany',
      'api::filter-item.filter-item'
    >;
    top_filter_items: Attribute.Relation<
      'api::filter.filter',
      'oneToMany',
      'api::top-filter-item.top-filter-item'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiFilterItemFilterItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    allow_actions: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiGlobalLayerGlobalLayer extends Schema.CollectionType {
  collectionName: 'global_layers';
  info: {
    singularName: 'global-layer';
    pluralName: 'global-layers';
    displayName: 'Global layer';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiInfrastructureInfrastructure extends Schema.CollectionType {
  ...
  attributes: {
    ...
    filters: Attribute.Relation<
      ...
      'api::filter.filter'
    >;
    top_filters: Attribute.Relation<
      'api::infrastructure.infrastructure',
      'oneToMany',
...
export interface ApiMapConfigurationMapConfiguration extends Schema.SingleType {
  collectionName: 'map_configurations';
  info: {
    singularName: 'map-configuration';
    pluralName: 'map-configurations';
  ...
  attributes: {
    ...
    longitute: Attribute.Float;
    default_zoom: Attribute.Integer;
    min_zoom: Attribute.Integer;
    max_zoom: Attribute.Integer;
    tile_url: Attribute.Text;
    tile_attribution: Attribute.String;
    tile_access_token: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTopFilterTopFilter extends Schema.CollectionType {
...
export interface ApiTopFilterItemTopFilterItem extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::global-layer.global-layer': ApiGlobalLayerGlobalLayer;
      'api::infrastructure.infrastructure': ApiInfrastructureInfrastructure;
      'api::layout.layout': ApiLayoutLayout;
      'api::map-configuration.map-configuration': ApiMapConfigurationMapConfiguration;
      'api::top-filter.top-filter': ApiTopFilterTopFilter;
      'api::top-filter-item.top-filter-item': ApiTopFilterItemTopFilterItem;
    }
  }
}
